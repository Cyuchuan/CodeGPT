package ee.carlrobert.codegpt.codedown.model;

import com.google.gson.GsonBuilder;
import ee.carlrobert.codegpt.codedown.Constants;
...
public class MethodDescription {
    ...
    protected MethodDescription(ClassDescription classDescription, List<String> attributes,
                                String methodName, String returnType, List<String> argNames, List<String> argTypes, int offset,String methodBody) {
    ...
    public static MethodDescription createMethodDescription(ClassDescription classDescription,
                                                     ...
                                                     String returnType,
                                                     List<String> argNames, List<String> argTypes, int offset,String methodBody) {
        return new MethodDescription(classDescription, attributes, methodName, returnType, argNames, argTypes, offset, methodBody);
    }
